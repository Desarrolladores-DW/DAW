    ...
    <header class="hero">
        <nav class="nav container">
            ...
            <ul class="nav__link nav__link--menu">
                <li class="nav__items">
                    <a href="/DAW-MAIN/index_cursos.php" class="nav__links">Inicio</a>
                </li>
                <li class="nav__items">
                ...
                <li class="nav__items">
                    ...
                    <ul>
                        ...
                        <li><a href="./Cursos/Python/Index_Iniciado.html">Python</a></li>
                        <li><a href="./Cursos/PHP/Index_Iniciado.html">PHP</a></li>
                        <li><a href="./Cursos/Css/Index_Iniciado.html">CSS</a></li>
                        <li><a href="./Cursos/MYSQL/Index_Iniciado.html">MYSQL</a></li>
                        <li><a href="./Cursos/Java/Index_Iniciado.html">Java</a></li>
                    </ul>
                </li>
                <li class="nav__items">
                    <a href="/DAW-MAIN/Login_CodeLearn/php/cerrar_sesion.php" class="nav__links">Cerrar Sesión</a>
                </li>
        ...
        <section class="knowledge">
            <div class="knowledge__container container">
                <div class="knowledege__texts">
                    ...
                    <a href="./Cursos/Python/Index_Iniciado.html" class="cta">Entra al curso</a>
                </div>
                ...
                <section class="knowledge">
                    <div class="knowledge__container container">
                        <div class="knowledege__texts">
                            ...
                            <a href="./Cursos/HTML/Index_Iniciado.html" class="cta">Entra al curso</a> <br>
                            <br>
                ...
                <section class="knowledge">
                    <div class="knowledge__container container">
                        <div class="knowledege__texts">
                            ...
                            <p class="knowledge__paragraph"> El mejor lenguaje para contrucción de páginas web  </p>
                            <a href="./Cursos/Python/Index_Iniciado.html" class="cta">Entra al curso</a> <br>
                            <br>
                ...
                <section class="knowledge">
                    <div class="knowledge__container container">
                        <div class="knowledege__texts">
                            ...
                            <p class="knowledge__paragraph"> El mejor lenguaje para contrucción de páginas web  </p>
                            <a href="./Cursos/PHP/Index_Iniciado.html" class="cta">Entra al curso</a> <br>
                            <br>
                ...
                <section class="knowledge">
                    <div class="knowledge__container container">
                        <div class="knowledege__texts">
                            ...
                            <p class="knowledge__paragraph"> El mejor lenguaje para contrucción de páginas web  </p>
                            <a href="./Cursos/Css/Index_Iniciado.html" class="cta">Entra al curso</a> <br>
                            <br>
                ...
                <section class="knowledge">
                    <div class="knowledge__container container">
                        <div class="knowledege__texts">
                            ...
                            <p class="knowledge__paragraph"> El mejor lenguaje para contrucción de páginas web  </p>
                            <a href="./Cursos/MYSQL/Index_Iniciado.html" class="cta">Entra al curso</a> <br>
                            <br>
                ...
                <section class="knowledge">
                    <div class="knowledge__container container">
                        <div class="knowledege__texts">
                            ...
                            <p class="knowledge__paragraph"> El mejor lenguaje para contrucción de páginas web  </p>
                            <a href="./Cursos/Java/Index_Iniciado.html" class="cta">Entra al curso</a> <br>
                            <br>
